...
5a. **Protocol V2 only** (`ML-DEVOS-RFC-020`; active since `D-080`). When routing work back to the Builder, the same commit also publishes a new `coordination/CURRENT_DIRECTIVE.md` under a new `DIR-` ID, with:
