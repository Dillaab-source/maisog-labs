...
const spatialSchema = {
  ...
  destinations: [{ route: choice("systems", "projects", "journal", "contact"), text: text(120) }],
...
export function validateSpatialContent(document) {
  ...
  if (Array.isArray(document?.destinations) && document.destinations.map(item => item?.route).join() !== "systems,projects,journal,contact") {
    errors.push("spatial.destinations: must list systems, projects, journal, contact exactly once in that order");
  }
