...
- **G4 — Journal/case-study publishing (NOT IMPLEMENTED / FUTURE OPTION).** No journal content type, route, or schema field exists today (`brain/GOVERNANCE_MAP.md` row "Journal": `NOT STARTED`).
