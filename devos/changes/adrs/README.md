...
No ADR has been filed as of S1, since the ADR system is itself part of this cycle's deliverable. The frozen S0 constitutional rules (`../../governance/rules/core-rules.json`) predate this system and correctly carry `adr_id: null` — they remain valid and in force without one.
